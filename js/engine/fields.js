	    ...
	    setActive: function(bIsActive) {
	        ...
	        if (bIsActive) {
                ...
                for (var i = 0; i < aTds.length; i++) {
                    ...
                    aTds[i].style.background.replace("l.gif", "l.gif");
                    aTds[i].style.background =
                    aTds[i].style.background.replace("c.gif", "c.gif");
                    aTds[i].style.background =
                    aTds[i].style.background.replace("r.gif", "r.gif");
                }
	        }
	        else {
	...
	CFieldBlock,
	{
	    ...
	    _paint: function() {
	        ...
	        if (this._aChunks.length) {
	            ...
	            if (this._sType != "SINGLE_STATIC") {
	                sContent +=
	                    '<td align="center" style="width: 28px; height: 75px; background: url(\'./img/ui/field/l.gif\');"></td>';
	            }
	            for (var i = 0; i < this._aChunks.length; i++) {
	                if (this._sType == "SINGLE_FRAMED" || this._sType == "SINGLE_STATIC") {
	                    sContent +=
	                    '<td class="field_chunk" id="' + this._sInstance + '_chunk_' + i + '_place" align="center" style="background: url(\'./img/ui/field/c.gif\') repeat-x;">' + this._aChunks[i].value + '</td>';
	                }
	                else if (this._sType == "SINGLE_DYNAMIC") {
	                    sContent +=
	                    '<td class="field_chunk" align="center" style="background: url(\'./img/ui/field/c.gif\') repeat-x;"><div id="' + this._sInstance + '_chunk_' + i + '_place" style="width: ' + this._sWidth + 'px; overflow: hidden;"></div></td>';
	                }
	                else if (this._sType == "MULTI") {
	                    if (this._aChunks[i].type == "STATIC") {
	                        sContent +=
	                        '<td class="field_chunk" id="' + this._sInstance + '_chunk_' + i + '_place" align="center" style="width: 1144px; height: 75px; background: url(\'./img/ui/field/c.gif\') repeat-x;"></td>';
	                        this._aChunks[i]["place"] = this._sInstance + "_chunk_" + i + "_place";
	                    }
	                    else if (this._aChunks[i].type == "DYNAMIC") {
	                        sContent +=
	                        '<td class="field_chunk" id="' + this._sInstance + '_chunk_' + i + '_place" align="left" style="width: 1144px; background: url(\'./img/ui/field/c.gif\') repeat-x;"><div id="' + this._sInstance + '_chunk_' + i + '_place" style="width: 1144px; overflow: hidden;"></div></td>';
	                    }
	                }
	            }
	            if (this._sType != "SINGLE_STATIC") {
	                sContent +=
	                    '<td style="width: 28px; height: 75px; background: url(\'./img/ui/field/r.gif\');"></td>';
	            }
	            sContent +=
	                '  </tr>' +
                    '</table>';
	    ...
	    setActive: function(bIsActive) {
	        ...
	        if (bIsActive) {
                ...
                for (var i = 0; i < aTds.length; i++) {
                    aTds[i].style.background =
                    aTds[i].style.background.replace("ld.gif", "l.gif");
                    aTds[i].style.background =
                    aTds[i].style.background.replace("cd.gif", "c.gif");
                    aTds[i].style.background =
                    aTds[i].style.background.replace("rd.gif", "r.gif");
                }
	        }
	        else {
	            if (!this.getParent().isOneBlock()) {
	                for (var i = 0; i < aTds.length; i++) {
	                    aTds[i].style.background =
	                    aTds[i].style.background.replace("l_ad.gif", "l.gif");
	                    aTds[i].style.background =
	                    aTds[i].style.background.replace("c_ad.gif", "c.gif");
	                    aTds[i].style.background =
	                    aTds[i].style.background.replace("r_ad.gif", "r.gif");
	                }
	            }
	            else {
	                for (var i = 0; i < aTds.length; i++) {
	...
	CControl,
	{
	    ...
	    _paint: function() {
	        ...
	        if (this._aBlockCfgs.length) {
	            sContent += this._sHeader.toFormat(" color: #000000; font-size: 23px; font-weight: bold;") + "<br />";
	            sContent +=
	            ...
	            for (var i = 0; i < this._aBlockCfgs.length; i++) {
	                ...
	                if (i < this._aBlockCfgs.length - 1) {
	                    sContent += '<td style="width: 8px;"></td>';
	                }
	            }
	            sContent +=
                    ' </tr>' +
                    '</table>' +
                    '</div>';
	            sContent += this._sFooter.toFormat(" color: #000000; margin-top: 10px;font-size: 22px; font-weight: bold;");
	            insertContent(this.getPlaceId(), sContent);
	            for (var i = 0; i < this._aBlockCfgs.length; i++) {
