...
(
	CInputTab,
	{
	    ...
	    _prepareTemplate: function() {
	        ...
	        if (!$isNoU($(this._sPlace))) {
	            ...
	            sContent +=
	                ...
	                '      <table cellpadding="0" cellspacing="0" border="0">' +
	                '        <tr>' +
	                '          <td align="left" width="190" height="100%">' +
	                '          </td>' +
	                '          <td id="' + this._sInstance + '_fields_place"></td>' +
                    	'          <td valign="middle"><div id="' + this._sInstance + '_bs" style="width: 251px; height: 121px;"></div></td>' +
	                '        </tr>' +
	                '      </table>' +
	                '    </td>' +
	                '  </tr>' +
	    ...
	    _paint: function() {
	        ...
	        this._renderBS(this._sInstance + "_bs");  //tab_bs
	    },
	    ...
	    _renderBS: function(sPlace) {
	        ...
	        var sLang = storage.get("language");
	            ...
	            var oBtn = new CImageButton(this, "bs_btn", sPlace, "BACKSPACE", "./img/ui/delbtn_" + sLang + ".gif", "./img/ui/delbtn_" + sLang + ".gif");
